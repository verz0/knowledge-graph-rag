...
const SmartRAG = () => {
  ...
  const sampleQueries = [
    ...
    'Adventure activities in Southeast Asia',
    'Cultural experiences in South America',
    'Family-friendly beaches in the Caribbean',
    'Historical sites in the Mediterranean'
  ];
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 4 }}>
      {/* Header */}
      <Fade in timeout={600}>
        <Paper elevation={2} sx={{ p: 4, mb: 4, borderRadius: 3, textAlign: 'center', bgcolor: 'background.paper' }}>
          <AutoAwesomeIcon sx={{ fontSize: 64, color: 'primary.main', mb: 2 }} />
          <Typography variant="h3" component="h1" gutterBottom sx={{ fontWeight: 600 }}>
            Smart RAG Travel Assistant
          </Typography>
          <Typography variant="h6" color="text.secondary" paragraph>
            Get intelligent travel recommendations powered by our comprehensive knowledge base
          </Typography>
          ...
          <Box sx={{ maxWidth: 800, mx: 'auto', mt: 3 }}>
            <TextField
              ...
              placeholder="e.g., Best places to visit for a romantic honeymoon"
              size="medium"
              sx={{ mb: 2 }}
              InputProps={{
                endAdornment: (
        ...
        <Box sx={{ display: 'flex', justifyContent: 'center', my: 4 }}>
          <Box sx={{ textAlign: 'center' }}>
            ...
            <Typography variant="body1" color="text.secondary">
              Analyzing travel data and generating personalized recommendations...
            </Typography>
          </Box>
        </Box>
      )}
                    ...
                    <CardContent sx={{ flexGrow: 1, p: 3 }}>
                      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 2 }}>
                        ...
                        <Chip
                          label={`${suggestion.relevance}% match`}
                          size="small"
                          color={suggestion.relevance >= 90 ? 'success' : suggestion.relevance >= 80 ? 'warning' : 'default'}
                          sx={{ ml: 1 }}
                        />
                      </Box>
      ...
      {suggestions.length === 0 && !loading && (
        <Fade in timeout={1000}>
          <Paper elevation={1} sx={{ p: 4, mt: 4, borderRadius: 3, bgcolor: 'grey.50' }}>
            ...
            <Grid container spacing={3}>
              <Grid item xs={12} md={4}>
                <Box sx={{ textAlign: 'center' }}>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    Our AI understands your travel preferences and searches through our comprehensive knowledge base
                  </Typography>
                </Box>
              </Grid>
              <Grid item xs={12} md={4}>
                <Box sx={{ textAlign: 'center' }}>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    Get personalized suggestions based on cultural connections, seasonal factors, and travel patterns
                  </Typography>
                </Box>
              </Grid>
              <Grid item xs={12} md={4}>
                <Box sx={{ textAlign: 'center' }}>
                  <TravelIcon sx={{ fontSize: 48, color: 'success.main', mb: 1 }} />
                  <Typography variant="h6" gutterBottom>
                    Curated Results
                  </Typography>
                  <Typography variant="body2" color="text.secondary">
                    Receive ranked recommendations with detailed insights and practical travel information
                  </Typography>
                </Box>
              </Grid>
            </Grid>
